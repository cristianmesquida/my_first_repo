...
p + geom_point() + geom_smooth(method = "lm", se = FALSE) +
  ...
  title(main = "Relationship between Sprint swimming and Power output") +
  theme(panel.background = element_blank(),axis.line = element_line(colour = "black"))
```

## Conclusion
There is a strong relationship between swimming velocity and power output regardless of skill level. We can therefore strongly recommend the implementation of strength training as a part of training programme for swimming performance enhancement.
